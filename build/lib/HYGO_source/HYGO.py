...
def check_conditional_parameter(HYGO_parameters, parameter_names, parent, parent_condition, parameter, valid_types, valid_options=None, default=None, specific_condition=None):
    ...
    if parent in parameter_names:
        ...
        if eval(parent_condition):
            ...
            raise ValueError(f'Parameter {parameter}, which depends on {parent} violates condition '+parent_condition.replace('value',parent))
...
class HYGO():
    ...
    REQUIRED_PARAMETERS = [
            ...
            {'parameter':'p_replication','type':float,'default':0.0,'specific':['value<=1','value>=0']},
            {'parameter':'p_crossover','type':float,'default':0.55,'specific':['value<=1','value>=0']},
            {'parameter':'p_mutation','type':float,'default':0.45,'specific':['value<=1','value>=0']},
    ...
    CONDITIONAL_PARAMETERS = [
            ...
            {'parameter':'mutation_rate','type':int,'parent':'mutation_type','parent_condition':'value=="classic"','specific':'value>0'},
            ...
            {'parameter':'reflection_alpha','type':float,'parent':'ExploitationType','parent_condition':'value=="Downhill Simplex"','specific':'value>0','default':1},
            {'parameter':'expansion_gamma','type':float,'parent':'ExploitationType','parent_condition':'value=="Downhill Simplex"','specific':'value>0','default':2},
            {'parameter':'contraction_rho','type':float,'parent':'ExploitationType','parent_condition':'value=="Downhill Simplex"','specific':'value>0','default':0.5},
            {'parameter':'shrinkage_sigma','type':float,'parent':'ExploitationType','parent_condition':'value=="Downhill Simplex"','specific':'value>0','default':0.5},
        ]
